...
\title{Pratique et histoire de la statistique en écologie}
...
\doi{\url{https://github.com/norival/crBiometrie}}
...
Elle représente des coeffficients de corrélation de Pearson entre la taille de
la bavette chez le moineau commun (espèce depuis longtemps disparue, un spécimen
empaillé est visible au Muséum d'Histoire Naturelle de Terminus), et leur statu
social.
